...
const SECTIONS = [
  {
    ...
    content: [
      'By accessing or using the Cyberteks-IT website (cyberteks-it.com) or our Learning Management System (LMS) platform, you agree to be bound by these Terms of Use.',
      'If you do not agree to these terms, please discontinue use of our website and services immediately.',
      'These terms apply to all visitors, registered users, students, and clients of Cyberteks-IT Limited.',
    ],
  },
  {
    id: 'services',
    ...
    content: [
      'Cyberteks-IT provides ICT solutions including remote IT support, CCTV installation, access control systems, VoIP telephony, software development, and ICT skills training.',
  ...
  },
  {
    ...
    content: [
      ...
      'Cyberteks-IT reserves the right to suspend or terminate accounts that violate these terms.',
    ],
  },
  {
    id: 'training',
  ...
  },
  {
    ...
    content: [
      'Remote IT support sessions are conducted with your explicit permission. You must not grant remote access to Cyberteks-IT staff unless you have verified their identity.',
      ...
      'Cyberteks-IT is not liable for data loss resulting from hardware failures or actions outside our control during a support session.',
  ...
  },
  {
    ...
    content: [
      'To the maximum extent permitted by applicable law, Cyberteks-IT shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of our services.',
      'Our total liability to you for any claim arising from use of our services shall not exceed the amount paid by you to Cyberteks-IT in the three months preceding the claim.',
      'Cyberteks-IT makes no warranty that the website or LMS will be error-free or uninterrupted, though we strive for high availability.',
    ],
  },
  {
    id: 'privacy',
  ...
  },
  {
    ...
    content: [
      'Cyberteks-IT reserves the right to modify these Terms of Use at any time. The "Last Updated" date will reflect the most recent revision.',
      ...
      <section className="bg-[#023064] pt-12 pb-14 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-blue-200 text-lg max-w-2xl">
            These terms govern your use of the Cyberteks-IT website and LMS platform.
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-amber-50 border border-amber-100 rounded-2xl p-6 mb-10">
            <p className="text-gray-700 leading-relaxed text-sm">
              ...
              between you and Cyberteks-IT Limited, a company registered in Kampala, Uganda. By accessing our
