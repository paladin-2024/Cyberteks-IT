...
const conversations = [
  { id: '1', name: 'Aisha Nakato',    avatar: 'AN', course: 'Web Development', last: 'Thank you for the feedback on my assignment!',     time: '10:32 AM', unread: 2, active: true },
  { id: '2', name: 'David Ochieng',   avatar: 'DO', course: 'Web Development', last: 'Could you clarify lesson 12 on React hooks?',       time: 'Yesterday', unread: 0, active: false },
  { id: '3', name: 'Grace Atuhaire',  avatar: 'GA', course: 'IT Support',      last: 'I submitted my project. Please review.',            time: 'Mon',       unread: 1, active: false },
  { id: '4', name: 'Moses Ssemakula', avatar: 'MS', course: 'IT Support',      last: 'When is the next live session?',                   time: 'Sun',       unread: 0, active: false },
];

const messages = [
  { id: '1', from: 'them', text: 'Hi Dr. Kiprotich! I just finished lesson 8 and it was super clear.',                                           time: '10:15 AM' },
  { id: '2', from: 'me',   text: 'Great to hear that, Aisha! Let me know if you have any questions.',                                             time: '10:18 AM' },
  { id: '3', from: 'them', text: 'I do have one question — in the CSS grid exercise, should we use fr units or percentages?',                     time: '10:20 AM' },
  { id: '4', from: 'me',   text: 'Both work, but fr units are preferred for responsive layouts. Check the MDN docs for grid-template-columns.',   time: '10:25 AM' },
  { id: '5', from: 'them', text: 'Thank you for the feedback on my assignment!',                                                                   time: '10:32 AM' },
];

export default function TeacherMessagesPage() {
  const { t } = useLanguage();
  const d = t.lms.teacher.messages;
      ...
      <div className="bg-card border border-border rounded-2xl overflow-hidden flex h-[calc(100vh-12rem)]">
            ...
            {conversations.map((conv) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground mb-1">{conv.course}</p>
        ...
        <div className="flex-1 flex flex-col">
          <div className="px-6 py-4 border-b border-border flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground text-sm">Aisha Nakato</p>
