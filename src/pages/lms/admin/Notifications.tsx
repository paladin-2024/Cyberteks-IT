...
import { Bell, CheckCheck, ExternalLink, Info, AlertTriangle, CheckCircle2, XCircle, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-3xl pb-8">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-12 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-slate-400">New student applications will appear here.</p>
        </div>
      ) : (
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  n.isRead ? 'border-slate-200 opacity-70' : 'border-slate-200 shadow-sm ring-1 ring-primary-blue/10'
                )}
              >
