    ...
    <div className="mx-auto max-w-5xl px-4 md:px-6 lg:px-8">
      ...
      <div className="mt-6 space-y-5 text-sm text-slate-700">
        <section>
          ...
          <p className="mt-2 text-xs font-semibold text-slate-700">a. Personal Information</p>
          ...
          <p className="mt-3 text-xs font-semibold text-slate-700">b. Non-Personal Information</p>
          <ul className="mt-1 space-y-1 text-xs text-slate-600">
            <li>• IP address, browser type, device information</li>
            <li>• Pages visited, time spent, and other analytics data</li>
            <li>• Cookies and tracking technologies (see Section 6)</li>
          </ul>
          <p className="mt-3 text-xs font-semibold text-slate-700">c. Service-Specific Data</p>
          <ul className="mt-1 space-y-1 text-xs text-slate-600">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">3. Sharing Your Information</h2>
          <ul className="mt-2 space-y-1 text-xs text-slate-600">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">6. Cookies & Tracking Technologies</h2>
          <p className="mt-2 text-xs text-slate-600">
        ...
        <section>
          ...
          <p className="mt-2 text-xs text-slate-600">To exercise these rights, contact us using the details below.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-slate-900">8. Third-Party Links</h2>
          <p className="mt-2 text-xs text-slate-600">
        ...
        <section>
          <h2 className="text-lg font-semibold text-slate-900">9. Changes to This Privacy Policy</h2>
          <p className="mt-2 text-xs text-slate-600">We may update this Privacy Policy from time to time.</p>
        </section>
